# Paper Profile #21: Advances in Continual Graph Learning for Anti-Money Laundering Systems: A Comprehensive Review

## Bibliographic Metadata
- **Paper Title:** Advances in Continual Graph Learning for Anti-Money Laundering Systems: A Comprehensive Review
- **Authors:** Deprez et al.
- **Publication Year:** 2025
- **Venue / Journal:** WIREs Computational Statistics, Wiley
- **Research Category:** Continual Learning & Concept Drift
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Continual Learning & Concept Drift (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
