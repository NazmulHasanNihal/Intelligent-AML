# Paper Profile #72: Safeguarding Fraud Detection from Attacks: A Robust Graph Learning Approach (GLSGNN)

## Bibliographic Metadata
- **Paper Title:** Safeguarding Fraud Detection from Attacks: A Robust Graph Learning Approach (GLSGNN)
- **Authors:** Wu et al. (Tongji / Tencent)
- **Publication Year:** 2024
- **Venue / Journal:** IJCAI 2024
