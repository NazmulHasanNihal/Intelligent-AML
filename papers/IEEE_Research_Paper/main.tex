...
\vspace{1.0ex}
{\footnotesize
\noindent\textbf{Md.~Nazmul} is pursuing the B.Sc. (Hons.) degree in Computer Science and Engineering at College of Technology, National University, Gazipur 1704, Bangladesh. His research focuses on graph representation learning, spatio-temporal neural networks, financial forensics, and distribution-free conformal risk control.\par\vspace{1.0ex}
\noindent\textbf{Musrat~Jahan~Gungun} is pursuing the B.Sc. (Hons.) degree in Computer Science and Engineering at College of Technology, National University, Gazipur 1704, Bangladesh. Her research focuses on machine learning, algorithmic fairness, and topological anomaly detection in transaction networks.\par\vspace{1.0ex}
\noindent\textbf{Maheli~Ahmed} is a Faculty Member in the Department of Computer Science and Engineering at College of Technology, National University, Gazipur 1704, Bangladesh. Her research interests include machine learning, deep learning, model risk governance, and financial fraud surveillance.\par
}
