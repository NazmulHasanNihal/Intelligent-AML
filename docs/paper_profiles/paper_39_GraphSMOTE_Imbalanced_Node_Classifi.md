# Paper Profile #39: GraphSMOTE: Imbalanced Node Classification on Graphs with Graph Neural Networks

## Bibliographic Metadata
- **Paper Title:** GraphSMOTE: Imbalanced Node Classification on Graphs with Graph Neural Networks
- **Authors:** Zhao et al.
- **Publication Year:** 2021
- **Venue / Journal:** ACM WSDM 2021
