import sys; hasattr(sys.stdout, 'reconfigure') and sys.stdout.reconfigure(encoding='utf-8')
"""
...
if __name__ == "__main__":
    print("\n" + "=" * 70)
    print(" INTELLIGENT AML — LAYER 1 OMNI-CHANNEL DATA INGESTION PIPELINE ")
    print("=" * 70)
    run_all_datasets()
    split_all_datasets()
    write_run_manifest(OUTPUT_DIR)
    print("\n✅ Layer 1 Ingestion Completed Successfully. Output directory:", OUTPUT_DIR.resolve())
