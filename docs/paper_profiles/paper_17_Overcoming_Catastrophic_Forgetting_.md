# Paper Profile #17: Overcoming Catastrophic Forgetting in Graph Neural Networks with Topology-Aware Weight Preserving (TWP)

## Bibliographic Metadata
- **Paper Title:** Overcoming Catastrophic Forgetting in Graph Neural Networks with Topology-Aware Weight Preserving (TWP)
- **Authors:** Liu et al.
- **Publication Year:** 2021
- **Venue / Journal:** ICML 2021
