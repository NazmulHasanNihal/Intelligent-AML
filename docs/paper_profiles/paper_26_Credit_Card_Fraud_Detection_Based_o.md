# Paper Profile #26: Credit Card Fraud Detection Based on Federated Graph Learning

## Bibliographic Metadata
- **Paper Title:** Credit Card Fraud Detection Based on Federated Graph Learning
- **Authors:** Tang & Liang
