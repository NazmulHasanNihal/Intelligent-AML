# Paper Profile #09: Network Analytics for Anti-Money Laundering: A Systematic Literature Review and Experimental Evaluation

## Bibliographic Metadata
- **Paper Title:** Network Analytics for Anti-Money Laundering: A Systematic Literature Review and Experimental Evaluation
- **Authors:** Deprez et al.
- **Publication Year:** 2025
- **Venue / Journal:** INFORMS Journal on Data Science
- **Research Category:** Temporal & Heterogeneous GNNs — Core Architecture
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Temporal & Heterogeneous GNNs — Core Architecture (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
