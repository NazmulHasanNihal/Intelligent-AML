# Paper Profile #02: Temporal Graph Networks for Deep Learning on Dynamic Graphs

## Bibliographic Metadata
- **Paper Title:** Temporal Graph Networks for Deep Learning on Dynamic Graphs
- **Authors:** Rossi et al.
- **Publication Year:** 2020
- **Venue / Journal:** ICML 2020 Graph Representation Learning Workshop
