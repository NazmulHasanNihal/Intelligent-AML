# Paper Profile #54: Transaction Fraud Detection via Attentional Spatial-Temporal GNN

## Bibliographic Metadata
- **Paper Title:** Transaction Fraud Detection via Attentional Spatial-Temporal GNN
- **Authors:** Khosravi et al.
- **Publication Year:** 2025
- **Venue / Journal:** Journal of Supercomputing (Springer)
