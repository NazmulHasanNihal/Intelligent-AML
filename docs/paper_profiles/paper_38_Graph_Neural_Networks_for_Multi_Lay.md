# Paper Profile #38: Graph Neural Networks for Multi-Layered Financial Crime Network Detection: An Explainable AI Framework for AML

## Bibliographic Metadata
- **Paper Title:** Graph Neural Networks for Multi-Layered Financial Crime Network Detection: An Explainable AI Framework for AML
- **Authors:** Olaniyi et al.
- **Publication Year:** 2026
- **Venue / Journal:** Journal of Engineering Research and Reports
- **Research Category:** Explainable AI (XAI) & Regulatory Compliance
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Explainable AI (XAI) & Regulatory Compliance (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
