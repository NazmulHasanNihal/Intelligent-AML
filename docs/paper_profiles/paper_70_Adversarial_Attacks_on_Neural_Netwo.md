# Paper Profile #70: Adversarial Attacks on Neural Networks for Graph Data (Nettack)

## Bibliographic Metadata
- **Paper Title:** Adversarial Attacks on Neural Networks for Graph Data (Nettack)
- **Authors:** Zügner et al. (TUM)
- **Publication Year:** 2018
- **Venue / Journal:** ACM SIGKDD 2018
