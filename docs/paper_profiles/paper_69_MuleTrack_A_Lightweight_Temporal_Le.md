# Paper Profile #69: MuleTrack: A Lightweight Temporal Learning Framework for Money Mule Detection in Digital Payments

## Bibliographic Metadata
- **Paper Title:** MuleTrack: A Lightweight Temporal Learning Framework for Money Mule Detection in Digital Payments
- **Authors:** Jambhrunkar et al.
- **Publication Year:** 2026
- **Venue / Journal:** Springer 2026
- **Research Category:** AML Alert Optimization & Production Systems
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to AML Alert Optimization & Production Systems (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
