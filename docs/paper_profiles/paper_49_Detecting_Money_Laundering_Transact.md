# Paper Profile #49: Detecting Money Laundering Transactions with Machine Learning

## Bibliographic Metadata
- **Paper Title:** Detecting Money Laundering Transactions with Machine Learning
- **Authors:** Jullum et al. (NR)
- **Publication Year:** 2020
- **Venue / Journal:** Journal of Money Laundering Control (Emerald)
