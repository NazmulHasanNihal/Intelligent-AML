...
\setlength{\textfloatsep}{7.0pt plus 2.0pt minus 1.0pt}
\setlength{\floatsep}{6.0pt plus 1.0pt minus 1.0pt}
\setlength{\intextsep}{6.0pt plus 1.0pt minus 1.0pt}
\setlength{\dbltextfloatsep}{7.0pt plus 2.0pt minus 1.0pt}
\setlength{\dblfloatsep}{6.0pt plus 1.0pt minus 1.0pt}

% Display Math Spacing
\setlength{\abovedisplayskip}{3.5pt plus 1.0pt minus 1.0pt}
\setlength{\belowdisplayskip}{3.5pt plus 1.0pt minus 1.0pt}
\setlength{\abovedisplayshortskip}{1.5pt plus 1.0pt minus 1.0pt}
\setlength{\belowdisplayshortskip}{1.5pt plus 1.0pt minus 1.0pt}

% Compact List Environments
\usepackage{enumitem}
\setlist{nosep,leftmargin=*,itemsep=1.5pt,topsep=2.5pt}

% Clean IEEE Bibliography Spacing
\def\IEEEbibitemsep{0.0pt plus 0.2pt minus 0.1pt}
...
is pursuing the B.Sc. (Hons.) degree in Computer Science and Engineering at College of Technology, National University, Bangladesh. His research focuses on graph representation learning, spatio-temporal neural networks, and conformal risk control.
\end{IEEEbiographynophoto}
\vspace{-3.0ex}
\begin{IEEEbiographynophoto}{Musrat~Jahan~Gungun}
is pursuing the B.Sc. (Hons.) degree in Computer Science and Engineering at College of Technology, National University, Bangladesh. Her research focuses on machine learning, algorithmic fairness, and topological anomaly detection.
\end{IEEEbiographynophoto}
\vspace{-3.0ex}
\begin{IEEEbiographynophoto}{Maheli~Ahmed}
is a Faculty Member with the Department of Computer Science and Engineering, College of Technology, National University, Bangladesh. Her research interests include machine learning, deep learning, model governance, and fraud surveillance.
\end{IEEEbiographynophoto}
}
