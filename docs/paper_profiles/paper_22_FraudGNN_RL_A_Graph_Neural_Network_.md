# Paper Profile #22: FraudGNN-RL: A Graph Neural Network with Reinforcement Learning for Adaptive Financial Fraud Detection

## Bibliographic Metadata
- **Paper Title:** FraudGNN-RL: A Graph Neural Network with Reinforcement Learning for Adaptive Financial Fraud Detection
- **Authors:** Zhang et al.
- **Publication Year:** 2025
- **Venue / Journal:** IEEE Open Journal of Computer Science
