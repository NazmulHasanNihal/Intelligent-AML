# Paper Profile #56: MAD: Multicriteria Anomaly Detection of Suspicious Financial Accounts from Billions of Cash Transactions

## Bibliographic Metadata
- **Paper Title:** MAD: Multicriteria Anomaly Detection of Suspicious Financial Accounts from Billions of Cash Transactions
- **Authors:** Paoletti et al. (Politecnico di Torino)
- **Publication Year:** 2025
- **Venue / Journal:** ACM SIGKDD 2025
- **Research Category:** Data Engineering, Streaming & Scalability
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Data Engineering, Streaming & Scalability (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
