# Paper Profile #63: Towards Learning to Discover Money Laundering Subnetwork in Massive Transaction Network

## Bibliographic Metadata
- **Paper Title:** Towards Learning to Discover Money Laundering Subnetwork in Massive Transaction Network
- **Authors:** Chai et al. (Ant Group)
- **Publication Year:** 2023
- **Venue / Journal:** AAAI 2023
- **Research Category:** AML Subgraph, Community & Ring Detection
- **Priority Level:** ★★★ CRITICAL

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to AML Subgraph, Community & Ring Detection (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
