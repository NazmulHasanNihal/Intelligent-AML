# Paper Profile #04: Finding Money Launderers Using Heterogeneous Graph Neural Networks

## Bibliographic Metadata
- **Paper Title:** Finding Money Launderers Using Heterogeneous Graph Neural Networks
- **Authors:** Johannessen & Jullum (DNB Bank)
- **Publication Year:** 2023
- **Venue / Journal:** Expert Systems with Applications (Elsevier)
