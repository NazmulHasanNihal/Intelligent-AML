# Paper Profile #18: Overcoming Catastrophic Forgetting in Neural Networks (EWC)

## Bibliographic Metadata
- **Paper Title:** Overcoming Catastrophic Forgetting in Neural Networks (EWC)
- **Authors:** Kirkpatrick et al. (DeepMind)
- **Publication Year:** 2017
- **Venue / Journal:** PNAS 2017
