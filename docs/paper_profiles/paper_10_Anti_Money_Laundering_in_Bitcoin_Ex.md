# Paper Profile #10: Anti-Money Laundering in Bitcoin: Experimenting with Graph Convolutional Networks for Financial Forensics (Elliptic)

## Bibliographic Metadata
- **Paper Title:** Anti-Money Laundering in Bitcoin: Experimenting with Graph Convolutional Networks for Financial Forensics (Elliptic)
- **Authors:** Weber et al. (MIT / IBM)
- **Publication Year:** 2019
- **Venue / Journal:** KDD FinTech Workshop 2019
- **Research Category:** Benchmark Datasets — Original Papers
- **Priority Level:** ★★★ CRITICAL

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Benchmark Datasets — Original Papers (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
