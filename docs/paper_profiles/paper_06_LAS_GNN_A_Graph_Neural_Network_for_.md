# Paper Profile #06: LAS-GNN: A Graph Neural Network for Temporal Money Laundering Motif Detection

## Bibliographic Metadata
- **Paper Title:** LAS-GNN: A Graph Neural Network for Temporal Money Laundering Motif Detection
- **Authors:** Blanusa et al. (IBM Research)
- **Publication Year:** 2025
- **Venue / Journal:** ACM ICAIF 2025
