# Paper Profile #53: Real-Time Dynamic Graph Learning with Temporal Attention for Financial Fraud Detection

## Bibliographic Metadata
- **Paper Title:** Real-Time Dynamic Graph Learning with Temporal Attention for Financial Fraud Detection
- **Authors:** Chen & Yang
- **Publication Year:** 2026
- **Venue / Journal:** Frontiers in AI (Feb 2026)
