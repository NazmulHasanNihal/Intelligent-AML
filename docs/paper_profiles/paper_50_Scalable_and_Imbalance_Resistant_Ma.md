# Paper Profile #50: Scalable and Imbalance-Resistant Machine Learning Models for Anti-Money Laundering: A Two-Layered Approach

## Bibliographic Metadata
- **Paper Title:** Scalable and Imbalance-Resistant Machine Learning Models for Anti-Money Laundering: A Two-Layered Approach
- **Authors:** Tertychnyi et al. (Univ of Tartu)
- **Publication Year:** 2020
- **Venue / Journal:** Springer 2020
- **Research Category:** Mobile Financial Services & Bangladesh Context
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Mobile Financial Services & Bangladesh Context (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
