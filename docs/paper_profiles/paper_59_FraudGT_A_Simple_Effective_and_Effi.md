# Paper Profile #59: FraudGT: A Simple, Effective, and Efficient Graph Transformer for Financial Fraud Detection

## Bibliographic Metadata
- **Paper Title:** FraudGT: A Simple, Effective, and Efficient Graph Transformer for Financial Fraud Detection
- **Authors:** Zhang et al. (IBM Research)
- **Publication Year:** 2024
- **Venue / Journal:** ACM ICAIF 2024
- **Research Category:** GNN Surveys & Foundation Models for Finance
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to GNN Surveys & Foundation Models for Finance (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
