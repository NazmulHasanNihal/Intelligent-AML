# Paper Profile #71: GNNGuard: Defending Graph Neural Networks Against Adversarial Attacks

## Bibliographic Metadata
- **Paper Title:** GNNGuard: Defending Graph Neural Networks Against Adversarial Attacks
- **Authors:** Zhang & Zitnik (Harvard)
