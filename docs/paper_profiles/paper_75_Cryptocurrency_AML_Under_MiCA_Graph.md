# Paper Profile #75: Cryptocurrency AML Under MiCA: Graph-Based Transaction Monitoring and Wallet Screening Requirements for CASPs

## Bibliographic Metadata
- **Paper Title:** Cryptocurrency AML Under MiCA: Graph-Based Transaction Monitoring and Wallet Screening Requirements for CASPs
- **Authors:** Jullum et al. / Elliptic Team
- **Publication Year:** 2025
- **Venue / Journal:** Journal of Financial Compliance
- **Research Category:** MiCA & Crypto AML Regulatory Compliance
- **Priority Level:** ★★★ CRITICAL

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to MiCA & Crypto AML Regulatory Compliance (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
