# Paper Profile #27: Federated Graph Anomaly Detection via Contrastive Self-Supervised Learning

## Bibliographic Metadata
- **Paper Title:** Federated Graph Anomaly Detection via Contrastive Self-Supervised Learning
- **Authors:** Kong et al.
- **Publication Year:** 2024
- **Venue / Journal:** IEEE TNNLS
