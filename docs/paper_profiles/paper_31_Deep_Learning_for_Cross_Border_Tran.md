# Paper Profile #31: Deep Learning for Cross-Border Transaction Anomaly Detection in Anti-Money Laundering Systems

## Bibliographic Metadata
- **Paper Title:** Deep Learning for Cross-Border Transaction Anomaly Detection in Anti-Money Laundering Systems
- **Authors:** Cross-Border AML Research Team
- **Publication Year:** 2024
- **Venue / Journal:** arXiv:2412.07027
- **Research Category:** Federated Learning & Differential Privacy
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Federated Learning & Differential Privacy (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
