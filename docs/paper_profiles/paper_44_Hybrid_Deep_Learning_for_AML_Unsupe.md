# Paper Profile #44: Hybrid Deep Learning for AML: Unsupervised Detection of Emerging Schemes via Feature Fusion and XAI

## Bibliographic Metadata
- **Paper Title:** Hybrid Deep Learning for AML: Unsupervised Detection of Emerging Schemes via Feature Fusion and XAI
- **Authors:** Elsevier ScienceDirect Authors
- **Publication Year:** 2026
- **Venue / Journal:** ScienceDirect (Jan 2026)
