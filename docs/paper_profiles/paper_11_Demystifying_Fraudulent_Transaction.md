# Paper Profile #11: Demystifying Fraudulent Transactions and Illicit Nodes in the Bitcoin Network (Elliptic++)

## Bibliographic Metadata
- **Paper Title:** Demystifying Fraudulent Transactions and Illicit Nodes in the Bitcoin Network (Elliptic++)
- **Authors:** Elmougy & Liu (Georgia Tech)
- **Publication Year:** 2023
- **Venue / Journal:** ACM KDD 2023
