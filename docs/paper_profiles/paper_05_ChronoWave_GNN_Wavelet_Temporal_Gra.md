# Paper Profile #05: ChronoWave-GNN: Wavelet-Temporal Graph Transformer for Anti-Money Laundering

## Bibliographic Metadata
- **Paper Title:** ChronoWave-GNN: Wavelet-Temporal Graph Transformer for Anti-Money Laundering
- **Authors:** Nature Scientific Reports Authors
- **Publication Year:** 2026
- **Venue / Journal:** Scientific Reports, Nature (Jan 2026)
