# Paper Profile #13: Realistic Synthetic Financial Transactions for Anti-Money Laundering Models (AMLWorld)

## Bibliographic Metadata
- **Paper Title:** Realistic Synthetic Financial Transactions for Anti-Money Laundering Models (AMLWorld)
- **Authors:** Altman et al. (IBM Research)
- **Publication Year:** 2023
- **Venue / Journal:** NeurIPS 2023 Datasets and Benchmarks Track
