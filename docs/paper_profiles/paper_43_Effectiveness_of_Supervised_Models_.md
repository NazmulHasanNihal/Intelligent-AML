# Paper Profile #43: Effectiveness of Supervised Models Hampered by Scarcity of Labelled Data and High Class Imbalance in Financial Crime

## Bibliographic Metadata
- **Paper Title:** Effectiveness of Supervised Models Hampered by Scarcity of Labelled Data and High Class Imbalance in Financial Crime
- **Authors:** Oztas et al.
- **Publication Year:** 2024
- **Venue / Journal:** Future Generation Computer Systems (Elsevier)
- **Research Category:** Class Imbalance & Graph Data Augmentation
- **Priority Level:** ★★ IMPORTANT

---

## 1. Input Data / Parameters Used
- **Datasets Employed:** Benchmark financial graph datasets relevant to Class Imbalance & Graph Data Augmentation (e.g., Elliptic v1/v2/++, PaySim, IBM AMLWorld, SAML-D, DGraphFin, ULB Credit Card, or live transaction streams).
